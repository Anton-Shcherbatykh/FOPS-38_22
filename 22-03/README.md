...
Настраиваю хостинг статического сайта. В меню бакета выбираю Веб-сайт (потом вкладка Хостинг), указываю главную страницу (ранее созданный index.html). Всё сохраняю.
...
Всё отображается корректно. Подключение защищено.
 
 ---

 Задание по AWS выполнить пока не могу. Не получается найти стабильно работающий сервис VPN.
